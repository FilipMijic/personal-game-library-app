...
export class GamesService {
  ...
  addGame(id: string, title: string, developer: string, publisher: string, genre: string, platform: number, status: string, imageUrl: string) {
    let newGame: Game;

    newGame = new Game(id, title, developer, genre, publisher, platform, status, imageUrl);
